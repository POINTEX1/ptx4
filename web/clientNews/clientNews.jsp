...
<html lang="es">
    <head>       
        ...
        <title> POINTEX | Noticias Cliente </title>
                                    ...
                                    <div class="widget-body no-padding">
                                        <div class="widget-body-toolbar">
                                            <object align="right"> 
                                                ...
                                                &nbsp;&nbsp;
                                                <button class="btn btn-labeled btn-default" name="btnAdd" type="button" onclick="location.href = 'ClientNewsAddServlet';" >
                                                    <span class="btn-label">
                                        ...
                                        <table id="datatable_col_reorder" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="list" items="${list}">
                                                    <tr>
                                                        <td><input type="checkbox" name="chk" value="<c:out value="${list.idClientNews}" />"/></td>  
                                                        <td><c:out value="${list.idClientNews}" /></td>
                                                        ...
                                                        <td>
                                                            <object align="right">
                                                                <a href="ClientNewsGetServlet?idClientNews=<c:out value="${list.idClientNews}" />">
                                                                ...
                                                                <button class="btn btn-labeled btn-danger" name="btnDelRow" onclick="confirmar('ClientNewsDeleteServlet?btnDelRow=x&idClientNews=<c:out value="${list.idClientNews}" />');">
