                                        ...
                                        <table id="datatable_col_reorder" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="list" items="${list}">
                                                    <tr>
                                                        <td><input type="checkbox" name="chk" value="<c:out value="${list.idExchangeable}"/>"/></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <td>
                                                                <object align="right">
                                                                    <a href="ExchangeableGetServlet?idExchangeable=<c:out value="${list.idExchangeable}" />">
                                                                ...
                                                                <button class="btn btn-labeled btn-danger" name="btnDelRow" onclick="confirmar('ExchangeableDeleteServlet?btnDelRow=x&idExchangeable=<c:out value="${list.idExchangeable}" />');">
