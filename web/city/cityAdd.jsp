                            ...
                            <div class="jarviswidget" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <form id="formAdd" name="formAdd" class="smart-form" novalidate="novalidate" action="CityAddServlet" method="POST">
                                            <fieldset>
                                                <section>
                                                    <c:if test="${msgErrorDup == null && msgErrorNameCity == null}" >
                                                        <label for="nameCity" class="input">
                                                            <input type="text" name="nameCity" id="nameCity" placeholder=" Nombre de ciudad" value="<c:out value="${city.nameCity}" />">
                                                        </label>
                                                    </c:if>
                                                    <c:if test="${msgErrorDup != null || msgErrorNameCity != null}" >
                                                        <div class="form-group has-error">
                                                            <div class="col-md-10">
                                                                <div class="input-group">                                                                
                                                                    <input class="form-control" type="text" name="nameCity" id="nameCity" placeholder=" Nombre de ciudad" value="<c:out value="${city.nameCity}" />">
