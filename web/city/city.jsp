                    ...
                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                        <ul id="sparks" class="">
                            <li class="sparks-info">
                                <h5> Reg. en DB <span class="txt-color-blue"><i class="fa fa-hdd" data-rel="bootstrap-tooltip" title="Total de ciudades"></i>&nbsp;<c:out value="${regCount}"/></span></h5>
                                    ...
                                    <div class="widget-body no-padding">
                                        <div class="widget-body-toolbar">
                                            <object align="right"> 
                                                ...
                                                &nbsp;&nbsp;
                                                <button class="btn btn-labeled btn-default" name="btnAddAdmin" type="button" onclick="location.href = 'CityAddServlet';" >
                                                    <span class="btn-label">
                                            ...
                                            <tbody>
                                                <c:forEach var="list" items="${list}">
                                                    <tr>
                                                        ...
                                                        <td><c:out value="${list.idCity}" /></td>
                                                        <td><c:out value="${list.nameCity}" /></td>
                                                        <td>
                                                            <object align="right">
                                                                <a href="CityGetServlet?idCity=<c:out value="${list.idCity}" />">
                                                                ...
                                                                <button class="btn btn-labeled btn-danger" name="btnDelRow" onclick="confirmar('CityDeleteServlet?btnDelRow=x&idCity=<c:out value="${list.idCity}" />');
                                                        return false;">
