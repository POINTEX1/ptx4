...
<html lang="es">
    <head>       
        ...
        <title> POINTEX | Universidades </title>
                                    ...
                                    <div class="widget-body no-padding">
                                        <div class="widget-body-toolbar">
                                            <object align="right"> 
                                                ...
                                                &nbsp;&nbsp;
                                                <button class="btn btn-labeled btn-default" name="btnAdd" type="button" onclick="location.href = 'UniversityAddServlet';" >
                                                    <span class="btn-label">
                                        ...
                                        <table id="datatable_col_reorder" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="list" items="${list}">
                                                    <tr>
                                                        <td><input type="checkbox" name="chk" value="<c:out value="${list.idUniversity}" />"/></td>
                                                        <td><c:out value="${list.idUniversity}" /></td>
                                                        <td><c:out value="${list.nameUniversity}" /></td>                                                       
                                                        <td>
                                                            <object align="right">
                                                                <a href="UniversityGetServlet?idUniversity=<c:out value="${list.idUniversity}" />">
                                                                ...
                                                                <button class="btn btn-labeled btn-danger" name="btnDelRow" onclick="confirmar('UniversityDeleteServlet?btnDelRow=x&idUniversity=<c:out value="${list.idUniversity}" />');">
