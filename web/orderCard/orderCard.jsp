...
<html lang="es">
    <head>       
        ...
        <title> POINTEX | Solicitud Tarjetas </title>
                                        ...
                                        <table id="datatable_col_reorder" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="list" items="${list}">
                                                    <tr>
                                                        <td><input type="checkbox" name="chk" value="<c:out value="${list.idOrder}" />"/></td>                                            
                                                        <td><c:out value="${list.idOrder}" /></td>                                                                                                                       
                                                        <td>
                                                        ...
                                                        <td>
                                                            <object align="right">
                                                                <a href="OrderCardGetServlet?idOrder=<c:out value="${list.idOrder}" />">
                                                                ...
                                                                <button class="btn btn-labeled btn-danger" name="btnDelRow" onclick="confirmar('OrderCardDeleteServlet?btnDelRow=x&idOrder=<c:out value="${list.idOrder}" />');">
