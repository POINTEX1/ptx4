...
<html lang="es">
    <head>       
        ...
        <title> POINTEX | Promociones </title>
                                    ...
                                    <div class="widget-body no-padding">
                                        <div class="widget-body-toolbar">
                                            <object align="right"> 
                                                ...
                                                &nbsp;&nbsp;
                                                <button class="btn btn-labeled btn-default" name="btnAdd" type="button" onclick="location.href = 'PromoAddServlet';" >
                                                    <span class="btn-label">
                                        ...
                                        <table id="datatable_col_reorder" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="list" items="${list}">
                                                    <tr>
                                                        <td><input type="checkbox" name="chk" value="<c:out value="${list.idPromo}" />"/></td>
                                                        <td><c:out value="${list.namePlace}" /></td>
                                                        <td><c:out value="${list.idPromo}" /></td>
                                                        <td><c:out value="${list.tittle}" /></td>
                                                        ...
                                                        <td><c:out value="${list.dateEnd}" /></td>                                                      
                                                        <td>
                                                            <object align="right">
                                                                <a href="PromoGetServlet?idPlace=<c:out value="${list.idPlace}" />&idPromo=<c:out value="${list.idPromo}" />">
                                                                ...
                                                                <button class="btn btn-labeled btn-danger" name="btnDelRow" onclick="confirmar('PromoDeleteServlet?btnDelRow=x&idPromo=<c:out value="${list.idPromo}" />');">
