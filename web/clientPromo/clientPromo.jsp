...
<html lang="es">
    <head>       
        ...
        <title> POINTEX | Promociones Cliente </title>
                                    ...
                                    <div class="widget-body no-padding">
                                        <div class="widget-body-toolbar">
                                            <object align="right"> 
                                                ...
                                                &nbsp;&nbsp;
                                                <button class="btn btn-labeled btn-default" name="btnAdd" type="button" onclick="location.href = 'ClientPromoAddServlet';" >
                                                    <span class="btn-label">
                                        ...
                                        <table id="datatable_col_reorder" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="list" items="${list}">
                                                    <tr>
                                                        <td><input type="checkbox" name="chk" value="<c:out value="${list.idPromo}" />-<c:out value="${list.rut}" />"/></td>
                                                        <td><c:out value="${list.namePlace}" /></td>
                                                        <td><c:out value="${list.idPromo}" /></td>
                                                        <td><c:out value="${list.tittlePromo}" /></td>

                                                        <td><c:out value="${list.rut}" />-<c:out value="${list.dv}" /></td>                                                                
                                                        <td><c:out value="${list.points}" /></td>                                                        
                                                        <td>
                                                            <object align="right">                                                                
                                                                <button class="btn btn-labeled btn-danger" name="btnDelRow" onclick="confirmar('ClientPromoDeleteServlet?btnDelRow=x&idPromo=<c:out value="${list.idPromo}" />&rut=<c:out value="${list.rut}" />');">
