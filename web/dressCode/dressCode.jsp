...
<html lang="es">
    <head>       
        ...
        <title> POINTEX | Código de Vestir </title>
                                            ...
                                            <tbody>
                                                <c:forEach var="list" items="${list}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <object align="right">
                                                                <a href="DressCodeGetServlet?idDressCode=<c:out value="${list.idDressCode}" />">
                                                                ...
                                                                <button class="btn btn-labeled btn-danger" name="btnDelRow" onclick="confirmar('DressCodeDeleteServlet?btnDelRow=x&idDressCode=<c:out value="${list.idDressCode}" />');">
