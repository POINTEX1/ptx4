                ...
                <div class="row">                  
                    <div class="col-lg-12"> 
                        <div class="table-responsive">
                            <!--DATATABLE -->
                            <form action="EventDeleteServlet" method="POST" name="form">
                                <div class="row-fluid">
                                    <div class="span12">                            
                                        <div class="box">  
                                            <!-- TITULO DATATABLE -->
                                            <div class="box-title">
                                                ...
                                                <object align="right"> 
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <!-- AGREGAR REGISTRO -->
                                                    <button class="btn btn-primary btn-mini" name="btnAddEvent" type="button" onclick="location.href = 'EventAddServlet';" ><font size="1"><strong>AGREGAR</strong></font></button>
                                                </object>
                                                </br>DB
                                            </div>
                                            <!-- /TITULO DATATABLE -->
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <c:forEach var="list" items="${list}">  
                                                                ...
                                                                <td class="center">
                                                                    <a href="EventGetServlet?idPlace=<c:out value="${list.idPlace}" />&idEvent=<c:out value="${list.idEvent}" />"><button class="btn btn-primary btn-mini" name="btnUpOne" type="button"><strong><font size="1">VER / ACTUALIZAR</font></strong></button></a>
                                                                </td>
                                                                <td class="center">                                                                    
                                                                    <button class="btn btn-danger btn-mini delete" name="btnDelRow" onclick="confirmar('EventDeleteServlet?btnDelRow=x&idEvent=<c:out value="${list.idEvent}" />');
