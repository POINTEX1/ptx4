...
<html lang="es">
    <head>       
        ...
        <title> POINTEX | Promociones Compradas Cliente</title>
                                    ...
                                    <div class="widget-body no-padding">
                                        <div class="widget-body-toolbar">
                                            <object align="right"> 
                                                ...
                                                &nbsp;&nbsp;
                                                <button class="btn btn-labeled btn-default" name="btnAdd" type="button" onclick="location.href = 'ClientPromoCheckoutAddServlet';" >
                                                    <span class="btn-label">
                                            ...
                                            <tbody>
                                                <c:forEach var="list" items="${list}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <object align="right">                                                                
                                                                <button class="btn btn-labeled btn-danger" name="btnDelRow" onclick="confirmar('ClientPromoCheckoutDeleteServlet?btnDelRow=x&idCheck=<c:out value="${list.idCheck}" />');">
