                ...
                <div class="row">                  
                    <div class="col-lg-12"> 
                        ...
                        <div class="table-responsive">
                            <form action="ClientPromoCheckoutDeleteServlet" method="POST" name="form">
                                <div class="row-fluid">
                                    <div class="span12">                            
                                        <div class="box">  
                                            <!-- TITULO DATATABLE -->
                                            <div class="box-title">
                                                ...
                                                <object align="right"> 
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <!-- AGREGAR REGISTRO -->
                                                    <button class="btn btn-primary btn-mini" name="btnAdd" type="button" onclick="location.href = 'ClientPromoCheckoutAddServlet';" ><font size="1"><strong>AGREGAR</strong></font></button>
                                                </object>
                                                </br>DB
                                            </div>
                                            <!-- /TITULO DATATABLE -->
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <c:forEach var="list" items="${list}">  
                                                                ...
                                                                <td class="center">                                                                   
                                                                    <button class="btn btn-danger btn-mini delete" name="btnDelRow" onclick="confirmar('ClientPromoCheckoutDeleteServlet?btnDelRow=x&idCheck=<c:out value="${list.idCheck}" />');
