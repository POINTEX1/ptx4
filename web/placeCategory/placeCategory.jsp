...
<html lang="es">
    <head>       
        ...
        <title> POINTEX | Categorías por Lugar </title>
                                    ...
                                    <div class="widget-body no-padding">
                                        <div class="widget-body-toolbar">
                                            <object align="right"> 
                                                ...
                                                &nbsp;&nbsp;
                                                <button class="btn btn-labeled btn-default" name="btnAdd" type="button" onclick="location.href = 'PlaceCategoryAddServlet';" >
                                                    <span class="btn-label">
                                        ...
                                        <table id="datatable_col_reorder" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="list" items="${list}">
                                                    <tr>
                                                        <td><input type="checkbox" name="chk" value="<c:out value="${list.idPlace}" />-<c:out value="${list.idCategory}" />"/></td>
                                                        <td><c:out value="${list.idPlace}" /></td>
                                                        ...
                                                        <td>
                                                            <object align="right">                                                               
                                                                <button class="btn btn-labeled btn-danger" name="btnDelRow" onclick="confirmar('PlaceCategoryDeleteServlet?btnDelRow=x&idPlace=<c:out value="${list.idPlace}" />&idCategory=<c:out value="${list.idCategory}" />');">
