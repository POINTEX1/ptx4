                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
                        <h1 class="page-title txt-color-blueDark">
                            ...
                            <a href="CardMainServlet">Mantenedor <span>Tarjetas</span></a>
                            <span>
                                >  
                                Agregar
                            </span>
                            ...
                            <div class="jarviswidget" id="wid-id-1" data-widget-editbutton="false" data-widget-custombutton="false">
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">
                                        ...
                                        <form action="CardAddServlet" method="POST" name="formAdd" id="formAdd" class="smart-form" novalidate="novalidate">
                                                    ...
                                                    <section class="col col-6">  
                                                        ...
                                                        <section>
                                                            ...
                                                            <label class="input state-disabled">
                                                                <input type="text" disabled value="<c:out value="${rut}" />-<c:out value="${dv}" />">
                                                        ...
                                                        <section>
                                                            ...
                                                            <label class="input state-disabled">
                                                                <input type="text" value="<c:out value="${firstname}" /><c:out value="${lastname}" />" disabled>
