<%-- 
    Document   : card
    Created on : 10-04-2014, 18:57:05 AM
                    ...
                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                        <ul id="sparks" class="">
                            <li class="sparks-info">
                                <h5> Reg. en DB <span class="txt-color-blue"><i class="glyphicon glyphicon-hdd" data-rel="bootstrap-tooltip" title="Total Tarjetas"></i>&nbsp;<c:out value="${regCount}"/></span></h5>
                                    ...
                                    <div class="widget-body no-padding">
                                        <div class="widget-body-toolbar">
                                            <object align="right"> 
                                                ...
                                                &nbsp;&nbsp;
                                                <button class="btn btn-labeled btn-default" name="btnAdd" type="button" onclick="location.href = 'CardBrowserServlet';" >
                                                    <span class="btn-label">
                                        ...
                                        <table id="datatable_col_reorder" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="list" items="${list}">
                                                    <tr>
                                                        <th><input type="checkbox" name="chk" value="<c:out value="${list.barCode}" />"/></th>
                                                        ...
                                                        <td><c:out value="${list.dateEndCard}" /></td>
                                                        <td>
                                                            <object align="right">
                                                                <a href="CardGetServlet?rut=<c:out value="${list.rut}" />&barCode=<c:out value="${list.barCode}" />">
                                                                ...
                                                                <button class="btn btn-labeled btn-danger" name="btnDelRow" onclick="confirmar('CardDeleteServlet?btnDelRow=x&barCode=<c:out value="${list.barCode}" />');
                                                        return false;">
