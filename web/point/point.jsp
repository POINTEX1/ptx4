...
<html lang="es">
    <head>       
        ...
        <title> POINTEX | Puntos Clientes </title>
                    ...
                    <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                        <ul id="sparks" class="">
                            <li class="sparks-info">
                                <h5> Reg. en DB <span class="txt-color-blue"><i class="glyphicon glyphicon-hdd" data-rel="bootstrap-tooltip"></i>&nbsp;<c:out value="${regCount}"/></span></h5>
                                    ...
                                    <div class="widget-body no-padding">
                                        <div class="widget-body-toolbar">
                                            <object align="right"> 
                                                ...
                                                &nbsp;&nbsp;
                                                <button class="btn btn-labeled btn-default" name="btnAdd" type="button" onclick="location.href = 'PointAddServlet';" >
                                                    <span class="btn-label">
                                        ...
                                        <table id="datatable_col_reorder" class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="list" items="${list}">
                                                    <tr>
                                                        <td><input type="checkbox" name="chk" value="<c:out value="${list.idPlace}" />-<c:out value="${list.rut}" />"/></td>
                                                        <td><c:out value="${list.namePlace}" /></td>
                                                        <td><c:out value="${list.nameCity}" /></td>
                                                        <td><c:out value="${list.rut}" />-<c:out value="${list.dv}" /></td>
                                                        <td><c:out value="${list.firstName}" /></td>
                                                        <td><c:out value="${list.lastName}" /></td>
                                                        <td><c:out value="${list.points}" /></td>
                                                        <td><c:out value="${list.totalPoint}" /></td>                                                        
                                                        <td>
                                                            <object align="right">
                                                                <a href="PointGetServlet?idPlace=<c:out value="${list.idPlace}"/>&rut=<c:out value="${list.rut}"/>">
                                                                ...
                                                                <button class="btn btn-labeled btn-danger" name="btnDelRow" onclick="confirmar('PointDeleteServlet?btnDelRow=x&idPlace=<c:out value="${list.idPlace}" />&rut=<c:out value="${list.rut}" />');">
